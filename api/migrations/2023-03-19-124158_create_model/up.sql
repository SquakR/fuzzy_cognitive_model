-- Your SQL goes here
CREATE TYPE node_value_type AS ENUM ('none', 'from_zero_to_one');
CREATE TABLE nodes (
...
ADD COLUMN node_value_type node_value_type NOT NULL DEFAULT 'none';
ALTER TABLE projects
ADD COLUMN arc_value_type arc_value_type NOT NULL DEFAULT 'symbolic';
ALTER TABLE plugins
ADD COLUMN node_value_type node_value_type;
ALTER TABLE plugins
